...
namespace SuperTileMapper
{
    public partial class PPURegEditor : Form
    {
        ...
        private void Redraw()
        {
            ...
            objsize.Text = ((Data.GetPPUReg(0x01) & 0xE0) >> 5).ToString();
            objselect.Text = ((Data.GetPPUReg(0x01) & 0x18) >> 3).ToString();
            objbase.Text = (Data.GetPPUReg(0x01) & 0x07).ToString();
            ...
            bgmode.Text = (Data.GetPPUReg(0x05) & 0x07).ToString();
            bg3priority.Checked = (Data.GetPPUReg(0x05) & 0x08) != 0x00;
            bg1chrsize.Checked = (Data.GetPPUReg(0x05) & 0x10) != 0x00;
            bg2chrsize.Checked = (Data.GetPPUReg(0x05) & 0x20) != 0x00;
            bg3chrsize.Checked = (Data.GetPPUReg(0x05) & 0x40) != 0x00;
            bg4chrsize.Checked = (Data.GetPPUReg(0x05) & 0x80) != 0x00;
            ...
            bg1scbase.Text = ((Data.GetPPUReg(0x07) & 0xFC) >> 2).ToString();
            bg1scsize.Text = (Data.GetPPUReg(0x07) & 0x03).ToString();

            reg2108.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x08), 2);
            bg2scbase.Text = ((Data.GetPPUReg(0x08) & 0xFC) >> 2).ToString();
            bg2scsize.Text = (Data.GetPPUReg(0x08) & 0x03).ToString();

            reg2109.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x09), 2);
            bg3scbase.Text = ((Data.GetPPUReg(0x09) & 0xFC) >> 2).ToString();
            bg3scsize.Text = (Data.GetPPUReg(0x09) & 0x03).ToString();

            reg210A.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x0A), 2);
            bg4scbase.Text = ((Data.GetPPUReg(0x0A) & 0xFC) >> 2).ToString();
            bg4scsize.Text = (Data.GetPPUReg(0x0A) & 0x03).ToString();

            reg210B.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x0B), 2);
            bg1chrbase.Text = (Data.GetPPUReg(0x0B) & 0x0F).ToString();
            bg2chrbase.Text = ((Data.GetPPUReg(0x0B) & 0xF0) >> 4).ToString();

            reg210C.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x0C), 2);
            bg3chrbase.Text = (Data.GetPPUReg(0x0C) & 0x0F).ToString();
            bg4chrbase.Text = ((Data.GetPPUReg(0x0C) & 0xF0) >> 4).ToString();
            ...
            m7screenover.Text = ((Data.GetPPUReg(0x1A) & 0xC0) >> 6).ToString();
            ...
            bg1winlog.Text = (Data.GetPPUReg(0x2A) & 0x03).ToString();
            bg2winlog.Text = ((Data.GetPPUReg(0x2A) & 0x0C) >> 2).ToString();
            bg3winlog.Text = ((Data.GetPPUReg(0x2A) & 0x30) >> 4).ToString();
            bg4winlog.Text = ((Data.GetPPUReg(0x2A) & 0xC0) >> 6).ToString();

            reg212B.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x2B), 2);
            objwinlog.Text = (Data.GetPPUReg(0x2B) & 0x03).ToString();
            colorwinlog.Text = ((Data.GetPPUReg(0x2B) & 0x0C) >> 2).ToString();
            ...
            colorwinmain.Text = ((Data.GetPPUReg(0x30) & 0xC0) >> 6).ToString();
            colorwinsub.Text = ((Data.GetPPUReg(0x30) & 0x30) >> 4).ToString();
            addsubfixed.Checked = (Data.GetPPUReg(0x30) & 0x02) != 0x00;
            directcolor.Checked = (Data.GetPPUReg(0x30) & 0x01) != 0x00;

            reg2131.Text = "$" + Util.DecToHex(Data.GetPPUReg(0x31), 2);
            addsubsel.Checked = (Data.GetPPUReg(0x31) & 0x80) != 0x00;
            halfsel.Checked = (Data.GetPPUReg(0x31) & 0x40) != 0x00;
            ...
            fixedblue.Text = ((Data.GetPPUReg(0x32) & 0x7C00) >> 10).ToString();
            fixedgreen.Text = ((Data.GetPPUReg(0x32) & 0x03E0) >> 5).ToString();
            fixedred.Text = (Data.GetPPUReg(0x32) & 0x001F).ToString();
            ...
            overscan.Checked = (Data.GetPPUReg(0x25) & 0x04) != 0x00;
            objvdisp.Checked = (Data.GetPPUReg(0x25) & 0x02) != 0x00;
        ...
        {
            Data.SetPPURegBits(idx, bit, cbox.Checked ? bit : 0);
